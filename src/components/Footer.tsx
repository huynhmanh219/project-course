...
const Footer: React.FC = () => {
  return (
    <footer className="w-full bg-gradient-to-r from-blue-50 via-white to-indigo-50 border-t border-blue-100 py-6 px-4 flex flex-col md:flex-row items-center justify-between text-gray-700 text-sm shadow-sm gap-2">
