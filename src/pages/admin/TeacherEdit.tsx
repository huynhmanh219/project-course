...
const TeacherEdit: React.FC = () => {
  ...
  return (
    <div className="p-8 max-w-xl mx-auto">
      <h1 className="text-2xl font-bold mb-4 text-blue-700">Sửa giảng viên</h1>
      <form className="bg-white p-6 rounded shadow flex flex-col gap-4" onSubmit={handleSubmit}>
        ...
        <div className="flex gap-2">
          ...
          <button type="button" className="bg-gray-400 text-white px-4 py-2 rounded hover:bg-gray-500" onClick={() => navigate('/admin/users')}>Hủy</button>
        </div>
      </form>
    </div>
  );
