        ...
        <CardContent className="p-6">
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-sm text-gray-600">
                  {lecture.content ? 'Có nội dung' : 'Chưa có nội dung'}
                </span>
              </div>
            </div>
          ...
          <div className="space-y-2">
            <Button 
              ...
              onClick={() => navigate(`/teacher/courses/${courseId}/chapters/${chapterId}/lectures/${lecture.id}`)}
            >
            ...
            <div className="flex gap-2">
              ...
              <Button 
                size="sm" 
                variant="outline"
                className={`flex-1 ${lecture.is_published ? 'text-yellow-600 border-yellow-200 hover:bg-yellow-50' : 'text-green-600 border-green-200 hover:bg-green-50'}`}
