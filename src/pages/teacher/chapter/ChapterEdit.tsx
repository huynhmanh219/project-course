...
import { ArrowLeft, Save, BookOpen, Hash, FileText, Layers, GraduationCap } from 'lucide-react';
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-4xl font-bold tracking-tight">Chỉnh sửa chương</h1>
                  <p className="text-blue-100 text-lg mt-1">Cập nhật thông tin chương</p>
                </div>
              </div>
            </div>
          </div>
