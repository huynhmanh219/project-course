...
import { ArrowLeft, Save, Plus, Trash2, HelpCircle, FileText, Hash, Edit2 } from 'lucide-react';
...
const QuestionEdit: React.FC = () => {
  ...
  const loadData = async () => {
    try {
      ...
      setFormData({
        ...
        points: questionData.points?.toString() || '1',
        explanation: questionData.explanation || '',
        is_required: questionData.is_required !== false,
        answers: questionData.answers && questionData.answers.length > 0
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert('Lỗi cập nhật câu hỏi: ' + (error.message || 'Unknown error'));
    } finally {
      setSubmitting(false);
    }
  };
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-4xl font-bold tracking-tight">Chỉnh sửa câu hỏi</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex gap-3 justify-end pt-6 border-t border-gray-200">
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="flex items-center gap-2 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white px-6 py-2 rounded-xl font-semibold shadow-lg text-base transition-all duration-200 disabled:opacity-50"
                >
                  {submitting ? (
                    <>
